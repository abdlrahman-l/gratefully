...
function SidebarRail({ className, ...props }: React.ComponentProps<'button'>) {
  ...
  return (
    <Button
      ...
      className={cn(
        'absolute inset-y-0 z-20 hidden h-auto w-4 -translate-x-1/2 rounded-none p-0 transition-all ease-linear group-data-[side=left]:-inset-e-4 group-data-[side=right]:inset-s-0 after:absolute after:inset-y-0 after:inset-s-1/2 after:w-0.5 hover:bg-transparent hover:after:bg-sidebar-border sm:flex',
